...
class KernelTest:
    ...
    def test_kernel(self, dataset):
        ...
        result = kernel.full(x1, x2, what=("y", "derivative", "param_derivatives"))
        assert_almost_equal(result["y"], dataset["y"])
        assert_almost_equal(result["derivative"], dataset["derivative"])
        assert_almost_equal(result["param_derivatives"], dataset["param_derivatives"])
    ...
    datasets = [
        {
            ...
            "params": {"lengthscales": [0.6], "variance": 0.75},
            "y": np.array(
                [
            ...
            "derivative": np.array(
                [
                    [[0.0, 0.01345566, 0.02691132], [0.00609675, 0.00203225, -0.0]],
                    [[0.0, 0.0, 0.0445924916840655], [0.008422433748856834, 0.0, 0.0]],
                ]
            ),
            "param_derivatives": [
                np.array([[0.11213051, 0.03387083], [0.14864164, 0.04211217]]),
                np.array([[0.02407022, 0.00514123], [0.03567399, 0.00673795]]),
            ],
        }
    ]
    ...
    datasets = [
        {
            ...
            "x2": np.array([[1, 2, 3], [4, 2, 1]]),
            "params": {"lengthscales": [0.6], "variance": 0.75},
            "y": np.array([[0.00879323, 0.00082427], [0.01579335, 0.00125588]]),
            "derivative": [
                np.array(
                    [[0.0, 0.00982927, 0.01965854], [0.00203448, 0.00067816, 0.0]]
                ),
                np.array([[0.0, 0.0, 0.03886061], [0.00325013, 0.0, 0.0]]),
            ],
            "param_derivatives": [
                np.array([[0.08191057, 0.01130266], [0.12953538, 0.01625065]]),
                np.array([[0.01172431, 0.00109902], [0.0210578, 0.00167451]]),
            ],
        }
    ]
    ...
    datasets = [
        {
            ...
            "x2": np.array([[1, 2, 3], [4, 2, 1]]),
            "params": {"lengthscales": [0.6], "variance": 0.75},
            "y": np.array([[0.00585567, 0.00033752], [0.01172022, 0.0005632]]),
            "derivative": np.array(
                [
                    [[0.0, 0.00778975, 0.0155795], [0.00101443, 0.00033814, 0.0]],
                    [[0.0, 0.0, 0.03401239], [0.00176941, 0.0, 0.0]],
                ]
            ),
            "param_derivatives": [
                np.array([[0.25815405, 0.04569556], [0.37882633, 0.06316224]]),
                np.array([[0.03356713, 0.00411306], [0.05560057, 0.00600802]]),
            ],
        }
    ]
    ...
    datasets = [
        {
            ...
            "derivative": np.array(
                [
                    ...
                    [
                        [0.0, 0.0, 0.016108],
                        [2.32915823e-05, 0.00000000e00, 0.00000000e00],
                    ],
                ]
            ),
            "param_derivatives": [
                np.array(
                    [[3.34713794e-02, 6.45311944e-05], [1.07386671e-01, 2.32915823e-04]]
                ),
                np.array(
                    [[9.63975726e-04, 9.29249200e-07], [3.86592014e-03, 3.72665317e-06]]
                ),
            ],
        }
    ]
